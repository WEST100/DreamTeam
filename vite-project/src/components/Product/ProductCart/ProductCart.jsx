        ...
        <div className="shop">
          <div className="shop__list">
            <div className="list__item">
              <img className="list__image" src={`https://exam-server-5c4e.onrender.com${product.image}`} alt="product-image" />
              <div className="list__content">
                ...
                <div className="content__price">
                  ...
                  <div className="price__block">
                    <h3>${product?.price}</h3>
                    <h6>{product?.discont_price > 0 ? `$${product?.discont_price}` : product?.discont_price}</h6>
                  </div>
                </div>
              </div>
            </div>
