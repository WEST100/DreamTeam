  ...
  return (
    <div className={`product__card ${theme ? "product__card-dark" : "product__card-light"}`}>
      ...
      <div className="product__icons">
        <svg onClick={handleSvgClickHeart} className="heart" width="48" height="41" viewBox="0 0 48 41" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg onClick={handleSvgClickCart} className="cart" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
